...
(2,'SAV Hornetwork',1),
(3,'SAV LENOVO 2025',1),
(4,'Technicien Hornetwork',1),
(5,'SAV DELL & Assistance utilisateur PYTEAS - CD13',1),
(6,'Travail interne',1);
/*!40000 ALTER TABLE `categories` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `prj_codes`
--

DROP TABLE IF EXISTS `prj_codes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prj_codes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `prj_codes`
--

LOCK TABLES `prj_codes` WRITE;
/*!40000 ALTER TABLE `prj_codes` DISABLE KEYS */;
INSERT INTO `prj_codes` VALUES
(1,'PRJ2024-0732','SAV CD04',1),
(2,'PRJ2025-0055','SAV Hornetwork',1),
(3,'PRJ2025-0056','Technicien Hornetwork',1),
(4,'PRJ2025-0058','SAV LENOVO 2025',1),
(5,'TEST','TEST',0);
/*!40000 ALTER TABLE `prj_codes` ENABLE KEYS */;
UNLOCK TABLES;
...
(14,1,'2025-04-16','verif le bon fonctionnement du domaine','verif le bon fonctionnement du domaine','pending','2025-04-16 04:35:54','critique','2025-04-16','standard',NULL,NULL),
(15,1,'2025-04-16','CHECK la boit mail','CHECK la boit mail','pending','2025-04-16 04:38:54','moyenne','2025-04-16','standard',NULL,NULL),
(17,3,'2025-04-16','MODIF DNS CDF FINANCE','TICJET 1190 - Création d\'un utilisateur@asdepret (CFC)','completed','2025-04-16 06:33:41','critique','2025-04-16','0','2025-04-17 09:46:33',NULL),
(18,3,'2025-04-16','Livraison PC','11 468	Création d\'un nouvel utilisateur CFC','completed','2025-04-16 06:34:45','basse','2025-04-23','0','2025-04-17 14:13:46',NULL),
(19,3,'2025-04-16','[LOCKSIGHT] - LARAB Ali - [22/04/2025]','[LOCKSIGHT] - LARAB Ali - [22/04/2025]','completed','2025-04-16 06:36:46','haute','2025-04-22','preparation_postes','2025-04-17 15:31:32',NULL),
(23,3,'2025-04-16','[BU] - Joseph Mondesir Gerald - [12/05/25]','[BU] - Joseph Mondesir Gerald - [12/05/25]','pending','2025-04-16 06:39:22','moyenne','2025-05-12','preparation_postes',NULL,NULL),
(24,3,'2025-04-16','[LOCKSIGHT] - KALOUSTIAN Joris - [12/05/2025]','[LOCKSIGHT] - KALOUSTIAN Joris - [12/05/2025]','pending','2025-04-16 06:40:08','moyenne','2025-05-12','preparation_postes',NULL,NULL),
(26,3,'2025-04-16','formation / . / formation / 000000 / Passage Certification DELL','Passage Certification DELL','in_progress','2025-04-16 16:49:02','basse','2025-04-30','formation',NULL,'.'),
(27,3,'2025-04-17','SFC DESIGN - Word Excel ne répond plus','HW180000866 / Louvet Antoine /  06-74-75-84-94','completed','2025-04-17 06:23:26','moyenne','2025-04-25','standard','2025-04-18 09:37:20',NULL),
(31,3,'2025-04-17','maintenance / 000000000 / RDV : CFC D&D FINANCE','Config DS Agent et Scan to folder','in_progress','2025-04-17 12:24:17','basse','2025-04-22','maintenance',NULL,''),
(32,3,'2025-04-17','[Communication] - BRUNET Manon- [30/04/2025]','[Communication] - BRUNET Manon- [30/04/2025]','completed','2025-04-17 13:33:14','moyenne','2025-04-30','preparation_postes','2025-04-22 15:36:01',NULL),
(33,3,'2025-04-17','Problème de son sur sa WEBCAM (11454)','Problème de son sur sa WEBCAM (11454)','completed','2025-04-17 14:03:53','moyenne','2025-04-17','standard','2025-04-17 16:10:55',NULL),
(35,3,'2025-04-18','CD13 -  INC - 149155/Arrêt suite à surchauffe','A Surveiller','in_progress','2025-04-18 06:37:04','basse','2025-04-25','traitement_incident',NULL,NULL),
(36,3,'2025-04-18','Pret de postes HW180000502','Pret de PC Corinne	LOUIRAZIN - Oublie P¨C maison','completed','2025-04-18 06:53:27','moyenne','2025-04-21','Demande de service','2025-04-22 10:49:46',NULL),
(37,1,'2025-04-18','TACHE DE TEST','TACHE DE TEST','pending','2025-04-18 12:03:46','critique','2025-04-21','standard',NULL,NULL),
(41,3,'2025-04-22','PRJ2025-0508 - Loc courte durée 1 mois - 4x PC','Loc courte durée 1 mois - 4x PC','completed','2025-04-22 08:53:01','moyenne',NULL,'preparation_postes','2025-04-23 07:33:54',NULL),
(42,3,'2025-04-22','PROCONSERV-IT','Le PC se connecte bien au Wi-Fi, internet ne fonctionne pas,','completed','2025-04-22 11:57:10','critique',NULL,'traitement_incident','2025-04-29 07:36:17',NULL),
(43,3,'2025-04-22','HORNETWORK - COORDEF INGENIERIE','La touche flèche de gauche et de droite ne fonctionne plus sur le clavier','completed','2025-04-22 12:33:37','moyenne',NULL,'Traitement d\'incident','2025-04-22 14:34:32',NULL),
(44,3,'2025-04-23','CD13 - INC - 147253/Panne Portable Getionnaire (acte III)','Perte des données suite à l\'intervention DELL','completed','2025-04-23 06:40:58','moyenne',NULL,'Traitement d\'incident','2025-04-23 08:41:55',NULL),
(45,3,'2025-04-23','Loc courte durée 1 mois - 4x PC','Envoyer mail au client avec les identifiant et MDP','completed','2025-04-23 07:33:34','moyenne',NULL,'Non catégorisé','2025-04-23 13:01:31',NULL),
(46,3,'2025-04-23','HorNetwork Incident 11594	- 	Problème d\'affichage','Problème d\'affichage','completed','2025-04-23 08:49:50','moyenne',NULL,'Traitement d\'incident','2025-04-23 08:50:40',NULL),
(47,3,'2025-04-23','11 314	Problème sur le Scan to Folder','Tout le monde serra présent pour le parramétrage des imprimantes','pending','2025-04-23 09:05:40','basse','2025-04-29','traitement_incident',NULL,NULL),
(48,3,'2025-04-23','COMMANDE SE2025-1219 (PRJ2025-0530)','Vente PC Client','completed','2025-04-23 14:51:54','critique','2025-04-24','preparation_postes','2025-04-25 06:17:42',NULL),
(49,3,'2025-04-24','Réunion PRJ2025-0435','Suite à la présentation rapide que je t\'ai faite hier ; \r\nJe te transmets les éléments concernant ta mission Helpdesk dans le cadre du projet de déploiement First Stop Ayme ;\r\nDossier : PRJ2025-0435\r\nÉgalement pour te donner plus d\'infos avant notre échange tout à l\'heure avec M. Sébastien Quidet, qui travaille au Helpdesk côté client.','completed','2025-04-25 06:19:55','moyenne','2025-04-24','Réunion','2025-04-25 06:20:37',NULL),
(50,3,'2025-04-25','CD13 - INT - 337619  - dock i-tec','Matériel/PDT - Poste de travail/UC Portable/Panne / - dock i-tec','completed','2025-04-25 06:29:14','haute','2025-04-30','traitement_incident','2025-04-29 07:35:34',NULL),
(51,3,'2025-04-25','Récupération d’un poste de location à réintégrer dans le stock.','HW180000646\r\nà faire \r\nMAJ HECTOR \r\nSUPPR GRSYSTEM\r\nNetoyage \r\nRangement placard','completed','2025-04-25 08:47:06','basse',NULL,'preparation_postes','2025-04-29 07:34:16',NULL),
(52,3,'2025-04-29','PRJ2025-0564 - Préparation PC','Ci-joint le PRJ : PRJ2025-0564 a préparé si possible aujourd’hui pour Léa M qui le remettra au client SPIGOL en main propre.','completed','2025-04-29 09:06:23','moyenne','2025-04-29','preparation_postes','2025-04-29 12:44:55',NULL),
(53,3,'2025-04-29','11 644	 Entité Racine CLIENTS HORNETWORK PROCONSERV-IT','Windows ne démmare pas','completed','2025-04-29 09:09:14','moyenne',NULL,'Traitement d\'incident','2025-04-29 09:09:48',NULL),
(54,3,'2025-05-05','FICHE D’ENTRÉE COLLABORATEUR - CASTRO Joris','Ajouter dans le TRELLO','pending','2025-05-05 06:42:22','haute','2025-05-12','preparation_postes',NULL,NULL),
(55,3,'2025-05-05','FICHE D’ENTRÉE COLLABORATEUR - NIEDZWESKI Alexandre','Demandeur : Hervé TALBOT / Entité Com Network','pending','2025-05-05 06:45:51','moyenne','2025-05-12','preparation_postes',NULL,NULL),
(56,3,'2025-05-05','FICHE D’ENTRÉE COLLABORATEUR - NIEDZWESKI  Alexandre','Demandeur :  Hervé TALBOT','pending','2025-05-05 06:48:21','moyenne','2025-05-12','preparation_postes',NULL,NULL),
(57,3,'2025-05-05','GLPI : 11490Paramétrage du scan pour le PC HW180000847','Paramétrer le SCAN TO FOLDER','completed','2025-05-05 07:15:50','moyenne','2025-05-08','Traitement d\'incident','2025-05-06 11:52:35',NULL),
(58,3,'2025-05-06','HorNetwork - Demande d\'installation des drivers d\'un Scanner (11752)','Installation de SCAN','completed','2025-05-06 11:45:25','haute','2025-05-06','Traitement d\'incident','2025-05-06 11:46:34',NULL),
(59,3,'2025-05-06','EDITION COMMANDE SE2025-0890 (PRJ2025-0556)','Projet : 2x PC + Access + Garantie 3 ans + SAV 2 ans - vente','completed','2025-05-06 11:49:11','moyenne','2025-05-06','preparation_postes','2025-05-06 11:50:11',NULL);
...
-- Dump completed on 2025-05-17  0:00:01
